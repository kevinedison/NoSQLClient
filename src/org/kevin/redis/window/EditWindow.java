...
public class EditWindow extends JFrame implements ActionListener {
    ...
    private static String editWindowTitle = "Edit window";
    ...
    public static void main(String[] args) {
        new EditWindow().instance().showWindow();
    }
    ...
    public void initHashTable(String key, final String tableType){
        ...
        table = new JTable(defaultModel);
        table.setRowSorter(new TableRowSorter<TableModel>(defaultModel));
        ...
        addSetBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(key.isEmpty()){
                    ...
                    int effectRow = new SetMan().edit(key, vectorValues);
                    if(effectRow > 0){
                        PopMessage.popMsg("Save data for key:[" + key + "] success");
                    } else {
                        PopMessage.popMsg("Save data for key:[" + key + "] fail");
    ...
    public void initStringTable(String key, final String tableType){
        ...
        addStrBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int effectRow = new StringMan().edit(key, value);
                if(effectRow > 0){
                    PopMessage.popMsg("Save data for key:[" + key + "] success");
                } else {
                    PopMessage.popMsg("Save data for key:[" + key + "] fail");
...
//            }
        ...
        if (e.getActionCommand().equals("Remove Row")) {
            ...
            if(rowselected >= 0){
                defaultModel.removeRow(rowselected);
